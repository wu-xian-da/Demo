	...
	<div class="col-md-12">
		<div class="box information-management-box">
			...
			<div class="operation-box">
				...
				<a href="./information-management-notice-add.html" class="btn btn-gy btn-add"><span class="glyphicon glyphicon-plus-sign"></span>新增</a>
				...
				<table class="table">
					...
					<tbody>
						<tr>
							...
							<td>关于2017年春运应急保障的紧急通知 <a href="#"><span class="glyphicon glyphicon-open"></span></a></td>
							<td>是</td>
							<td>2016/12/12</td>
							<td><span class="info-status">已上刊</span></td>
							<td><a href="./information-management-notice-edit.html" class="edit"><i></i>编辑</a> <a href="#" class="delete"><i></i>删除</a></td>
						</tr>

						<tr>
							<td><input type="checkbox"></td>
							<td>关于2017年春运应急保障的紧急通知</td>
							<td>是</td>
							<td>2016/12/12</td>
							<td><span class="info-status">已下刊</span></td>
							<td><a href="./information-management-notice-edit.html" class="edit"><i></i>编辑</a> <a href="#" class="delete"><i></i>删除</a></td>
						</tr>
					</tbody>
				</table>
